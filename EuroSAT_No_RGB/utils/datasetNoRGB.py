...
def plot_imeges(data,targets):
    ...
    BANDS = ['Aerosols (60m, 443nm)',  'Red edge 1 (20m, 705nm)', 'Red edge 2 (20m, 740nm)', 'Red edge3 (20m, 783nm)', 'NIR (10m, 842nm)',
...
class GetDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        image =np.delete(image, [1, 2, 3], 0) # removed RGB
...
#     train_loader = DataLoader(dataset=train_dataset, batch_size=32, num_workers=2, shuffle=True, pin_memory=True)
#     loop = tqdm(train_loader)
#     for batch_idx, (data, targets, paths) in enumerate(loop):
#
#         data = data[26]
#         targets = targets[26] # Select differen class
#         data = data.squeeze()
